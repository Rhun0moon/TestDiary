...
public class Fragment3 extends Fragment{
    ...
    private void initUI(ViewGroup rootView){
        ...
        xAxis3.setTextSize(Color.WHITE);
    ...
    private void setData1() {
        ...
        entries.add(new PieEntry(20f, "", getResources().getDrawable(R.drawable.smile4_24)));
        entries.add(new PieEntry(20.0f, "", getResources().getDrawable(R.drawable.smile5_24)));

        PieDataSet dataSet1 = new PieDataSet(entries, "기분별 비율");
